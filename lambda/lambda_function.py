...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        data["contents"][0]["parts"][0]["text"] = "Serás mi asistente de inteligencia artificial. Te daré órdenes e interactuaremos mientras te guío y te entreno."
...
class ChatIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if response.status_code == 200:
            ...
            speak_output = "No he recibido respuesta a su solicitud"
